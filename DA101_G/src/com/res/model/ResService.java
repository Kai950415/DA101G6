...
public class ResService
{
    ...
    public ResVO addRes(String res_adrs, String res_name, String res_ph, Integer res_point, String res_ac,
            String res_pass, byte[] res_img, String res_intro, String res_start, String res_end, Double res_lat,
            Double res_lot,
    ...
    public ResVO updateRes(String res_no, String res_adrs, String res_name, String res_ph, Integer res_point,
            String res_ac,
            String res_pass, byte[] res_img, String res_intro, String res_start, String res_end, Double res_lat,
            Double res_lot,
            Integer res_score, Integer res_cost, Integer res_comcount, String res_type, String res_status)
    ...
    public List<ResVO> getAllResVOByRes()
    {
        return dao.getAll().stream()
                .filter(res -> res.getRes_status().equals("res3"))
