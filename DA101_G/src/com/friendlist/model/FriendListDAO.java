...
public class FriendListDAO implements FriendListDAO_interface 
{
    ...
    private static final String INSERT_STMT = "INSERT INTO friendlist(F_NUM,F_NO,F_MEMNO,F_STATUS)VALUES (friend_seq.NEXTVAL,?, ?, 1)";
    private static final String UPDATE = "UPDATE friendList set F_NO=? F_MEMNO=? F_STATUS=? where F_NO =? and F_MEMNO=? and F_STATUS=?";
