...
('ME'||LPAD(to_char(mem_seq.NEXTVAL),6, '0'),'王','桃園市中壢區自強一路398號','男性',TO_DATE('2015-11-17','YYYY-MM-DD'),'0912345678','a12346@gmail.com','0',NULL,'111','123456','嗨!大家好我是王大明,我住在桃園中壢,歡迎大家一起來吃飯喔!','mem2');
Insert into mem (MEM_NO, MEM_NAME, MEM_ADRS, MEM_SEX, MEM_BD, MEM_PH, MEM_EMAIL,MEM_POINT, MEM_IMG, MEM_PASS, MEM_AC,MEM_INTRO,MEM_STATUS) values 
('ME'||LPAD(to_char(mem_seq.NEXTVAL),6, '0'),'Frank','桃園市觀音區中山路400號','男性',TO_DATE('1995-05-07','YYYY-MM-DD'),'0933448887','b12346@gmail.com','50',NULL,'222','123456','嗨!大家好我是法蘭克,我住在桃園觀音,可以一起來爬枕頭山喔!啾咪<3','mem1');
Insert into mem (MEM_NO, MEM_NAME, MEM_ADRS, MEM_SEX, MEM_BD, MEM_PH, MEM_EMAIL,MEM_POINT, MEM_IMG, MEM_PASS, MEM_AC,MEM_INTRO,MEM_STATUS) values 
('ME'||LPAD(to_char(mem_seq.NEXTVAL),6, '0'),'志玲','台北市信義區信義路五段7號','女性',TO_DATE('1974-11-29','YYYY-MM-DD'),'0933448887','c12346@gmail.com','1000',NULL,'333','123456','林志玲是臺灣女藝人，身兼模特兒、主持人、演員、歌手等身分。出生於臺北市，畢業於加拿大多倫多大學西方美術史、經濟學雙主修學士學位。 林志玲2004年開始在華人圈迅速竄紅，風靡大街小巷，帶起一股「林志玲熱」，讓模特兒不再局限於平面、走秀，開始紛紛跨足影視娛樂產業。','mem2');
Insert into mem (MEM_NO, MEM_NAME, MEM_ADRS, MEM_SEX, MEM_BD, MEM_PH, MEM_EMAIL,MEM_POINT, MEM_IMG, MEM_PASS, MEM_AC,MEM_INTRO,MEM_STATUS) values 
('ME'||LPAD(to_char(mem_seq.NEXTVAL),6, '0'),'王美','台北市中山區中山路177號','女性',TO_DATE('1990-06-17','YYYY-MM-DD'),'0912358746','d12346@gmail.com','99',NULL,'444','123456','美麗美麗,找不出其他的方式形容妳,別的話不準確一百萬個字句都不夠','mem2');
Insert into mem (MEM_NO, MEM_NAME, MEM_ADRS, MEM_SEX, MEM_BD, MEM_PH, MEM_EMAIL,MEM_POINT, MEM_IMG, MEM_PASS, MEM_AC,MEM_INTRO,MEM_STATUS) values 
('ME'||LPAD(to_char(mem_seq.NEXTVAL),6, '0'),'謝佾伸','桃園市平鎮區育達路160號附近','男性',TO_DATE('1989-05-17','YYYY-MM-DD'),'0987878787','e12346@gmail.com','30',NULL,'555','123456','大家好我是佾伸,我最喜歡上睡覺,下課打咚咚了,希望和大家一起做朋友喔~','mem2');
...
Insert into AD (AD_NO,AD_RESNO,AD_TEXT,AD_IMG,AD_START,AD_END,AD_TITLE)
values ('AD'||LPAD(to_char(ad_seq.NEXTVAL), 6, '0'),'RS000001','燒肉吃到飽壽星打折打到骨折',Null,TO_DATE('2019-06-16','YYYY-MM-DD'),TO_DATE('2019-06-20','YYYY-MM-DD'),'壽星打折');

Insert into AD (AD_NO,AD_RESNO,AD_TEXT,AD_IMG,AD_START,AD_END,AD_TITLE)
values ('AD'||LPAD(to_char(ad_seq.NEXTVAL), 6, '0'),'RS000002','謝師宴優惠，滿20人以上打九折',Null,TO_DATE('2019-06-01','YYYY-MM-DD'),TO_DATE('2019-07-01','YYYY-MM-DD'),'謝師宴優惠');

Insert into AD (AD_NO,AD_RESNO,AD_TEXT,AD_IMG,AD_START,AD_END,AD_TITLE)
values ('AD'||LPAD(to_char(ad_seq.NEXTVAL), 6, '0'),'RS000003','燒肉吃起來+100送日本和牛',Null,TO_DATE('2019-08-01','YYYY-MM-DD'),TO_DATE('2019-08-10','YYYY-MM-DD'),'+100送和牛');

Insert into AD (AD_NO,AD_RESNO,AD_TEXT,AD_IMG,AD_START,AD_END,AD_TITLE)
values ('AD'||LPAD(to_char(ad_seq.NEXTVAL), 6, '0'),'RS000004','慶祝同志可合法結婚，凡同志伴侶憑身分證享優惠現折100',Null,TO_DATE('2019-05-24','YYYY-MM-DD'),TO_DATE('2019-06-30','YYYY-MM-DD'),'慶祝同志合法結婚');

Insert into AD (AD_NO,AD_RESNO,AD_TEXT,AD_IMG,AD_START,AD_END,AD_TITLE)
values ('AD'||LPAD(to_char(ad_seq.NEXTVAL), 6, '0'),'RS000005','出示社群網站有加入韓總粉專者可免費升級吃到飽高級方案',Null,TO_DATE('2019-06-16','YYYY-MM-DD'),TO_DATE('2020-06-20','YYYY-MM-DD'),'韓粉發大財');
...
NOCACHE;
  ...
  (
      ...
      PT_MEMNO  VARCHAR2(8)  NOT NULL,
      PT_RESNO  VARCHAR2(8)  NOT NULL,
...
Insert into PointTransaction (PT_NO, PT_MEMNO, PT_RESNO) values ('PT'||LPAD(to_char(PointTransaction_seq.NEXTVAL), 6, '0'), 'ME000001','RS000001');
Insert into PointTransaction (PT_NO, PT_MEMNO, PT_RESNO) values ('PT'||LPAD(to_char(PointTransaction_seq.NEXTVAL), 6, '0'), 'ME000002','RS000002');
Insert into PointTransaction (PT_NO, PT_MEMNO, PT_RESNO) values ('PT'||LPAD(to_char(PointTransaction_seq.NEXTVAL), 6, '0'), 'ME000003','RS000003');
Insert into PointTransaction (PT_NO, PT_MEMNO, PT_RESNO) values ('PT'||LPAD(to_char(PointTransaction_seq.NEXTVAL), 6, '0'), 'ME000004','RS000004');
Insert into PointTransaction (PT_NO, PT_MEMNO, PT_RESNO) values ('PT'||LPAD(to_char(PointTransaction_seq.NEXTVAL), 6, '0'), 'ME000005','RS000005');
...
(
    ...
    FEA_DATE DATE Not null,
    FEA_STARTDATE DATE Not null,
    FEA_ENDDATE DATE,
...
Insert into post
(POST_NO,POST_MEMNO,POST_RES_NO,POST_TEXT,POST_IMG,POST_TIME,POST_RESPON,POST_RATE,POST_STATUS) values 
('PO'||LPAD(to_char(post_seq.NEXTVAL), 6, '0'), 'ME000002' ,'RS000002' , '今天揪的團真的是有夠難吃的!!還一堆死宅男跟來,真是受不了他們!' ,null,TO_TIMESTAMP('2019-06-11 19:00:00', 'YYYY-MM-DD HH24:MI:SS'),'fuckOff',2,'post1');
Insert into post
(POST_NO,POST_MEMNO,POST_RES_NO,POST_TEXT,POST_IMG,POST_TIME,POST_RESPON,POST_RATE,POST_STATUS) values 
...
Insert into leaveMessage (LM_NO, LM_POSTNO, LM_MEMNO, LM_TEXT, LM_STATUS) 
values ('LM'||LPAD(to_char(leaveMessage_seq.NEXTVAL), 6, '0'), 'PO000001', 'ME000002', '我跟你說隔壁餐廳很難吃,店員長得像含導演,令人作嘔!','lm1');
Insert into leaveMessage (LM_NO, LM_POSTNO, LM_MEMNO, LM_TEXT, LM_STATUS)
values ('LM'||LPAD(to_char(leaveMessage_seq.NEXTVAL), 6, '0'), 'PO000003', 'ME000003', '哈囉~能一起的參加這場飯局!我真的很開心喔~希望下次能有機會再約~<3','lm1');
Insert into leaveMessage (LM_NO, LM_POSTNO, LM_MEMNO, LM_TEXT, LM_STATUS)
...
insert into FRIENDLIST(F_NO,F_MEMNO,F_STATUS) values('ME000001','ME000002','f2');
