		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="/DA101G5">Home<span class="sr-only">(current)</span></a>
				</li>
        		...
        		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
         				<a class="dropdown-item" href="<%=request.getContextPath()%>/card/select_page.jsp">Select Card</a>
          				<a class="dropdown-item" href="<%=request.getContextPath()%>/card/listAllCard.jsp">List All</a>
         				<a class="dropdown-item" href="<%=request.getContextPath()%>/card/addCard.jsp">Add Card</a>
       			 </div>
     		     </li>
        		...
        		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
         				<a class="dropdown-item" href="<%=request.getContextPath()%>/commodity/select_page.jsp">Select Commodity</a>
          				<a class="dropdown-item" href="<%=request.getContextPath()%>/commodity/listAllCommodity.jsp">List All</a>
         				<a class="dropdown-item" href="<%=request.getContextPath()%>/commodity/addCommodity.jsp">Add Commodity</a>
       			 </div>
     		     </li>
